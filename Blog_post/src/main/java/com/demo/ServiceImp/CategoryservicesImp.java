...
public class CategoryservicesImp implements ICategory {
	...
	public CategoryDto getcategory(Long id) {
		...
		Category persistcategory = categor.orElseThrow(() -> new ResourseNotFound("Category id "+id+" not found "));
	...
	public void deleteCategory(Long id) {
		CategoryDto category = getcategory(id);
		Category percategory=this.dtoTocategory(category);
		this.repo.delete(percategory);
